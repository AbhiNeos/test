...
function fashion_shop_settings_page() {
    if (isset($_POST['fashion_shop_save']) && check_admin_referer('fs_settings_save')) {
        ...
        update_option('fashion_shop_whatsapp', sanitize_text_field($_POST['whatsapp']));
    ...
    <div class="wrap">
        ...
        <form method="post">
            ...
            <table class="form-table">
                ...
                <tr><th>WhatsApp Number</th><td><input type="text" name="whatsapp" value="<?php echo esc_attr(get_option('fashion_shop_whatsapp', '919876543210')); ?>" class="regular-text" placeholder="e.g., 919876543210 (country code + number, no +)"><p class="description">Country code + number without + or spaces. Orders will be sent here via WhatsApp.</p></td></tr>
