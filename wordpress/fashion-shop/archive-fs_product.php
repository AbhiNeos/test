...
<section class="section">
    <div class="container">
        <div class="shop-layout">
            ...
            <button class="filter-toggle-btn" onclick="document.querySelector('.shop-sidebar').classList.toggle('sidebar-open'); this.innerHTML = this.innerHTML.includes('Show') ? '<i class=\'fas fa-times\'></i> Hide Filters' : '<i class=\'fas fa-filter\'></i> Show Filters';">
